...
function preload(){
  ...
  shipImg3 = loadAnimation("ship-1.png");
  //shipImg1 = loadAnimation("ship-1.png");
  ...
  shipImg3 = loadAnimation("ship-2.png","ship-1.png","ship-2.png","ship-1.png");
...
function setup(){
  ...
  ship = createSprite(330,250,30,30);
  ship.addAnimation("movingShip",shipImg2);
  ship.scale =0.1;

  ship = createSprite(220,220,10,10);
